...
## Inputs
A task id, a task description, and `.agent/<task-id>/architecture.md` or an equivalently settled approach; `.agent/<task-id>/plan-review.md` when revising.
...
## Output
Write the plan to `.agent/<task-id>/plan.md`.
