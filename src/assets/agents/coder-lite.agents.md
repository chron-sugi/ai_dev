...
## Inputs
A task id and `.agent/<task-id>/plan.md` with approved status, with the assigned steps clearly identified; `.agent/<task-id>/code-review.md` when fixing review findings.
